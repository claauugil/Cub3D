...
/*   Updated: 2025/10/23 18:17:56 by claudia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void render_frame(t_game *game)
{
    ...
    for (int x = 0; x < WIN_W; x++)
    {
        ...
        int line_height = (int)(WIN_H / ray.perp_dist);
        if (line_height > WIN_H * 10)
            line_height = WIN_H * 10;
        ...
        if (tex_x < 0)
            tex_x = 0;
        if (tex_x >= game->tex[tex_num].width)
            tex_x = game->tex[tex_num].width - 1;
        ...
        for (int y = draw_start; y < draw_end; y++)
        {
            ...
            if (tex_y < 0)
                tex_y = 0;
            if (tex_y >= game->tex[tex_num].height)
                tex_y = game->tex[tex_num].height - 1;
